...
ob_start();
?>
<form action="../../controler/appartement/ajouter.php" method="post" class="form-control">
    ...
    <label for="surfaceEspaceCommun">Surface espace commun</label><input type="number" min="1" class="form-control" name="surfaceEspaceCommun" id="" required="required"></br>
